...
const FileInput: React.FC<FileInputProps> = ({
  ...
  const handleSelectFile = (e: React.MouseEvent<HTMLAnchorElement | HTMLButtonElement>) => {
    setSelectedFileURL("");
    e.preventDefault();
      ...
      >
        {selectedFile ? (
          <>
            {selectedFileURL &&
              (isVideo ? (
                <video width="100%" height="100%" controls autoPlay loop>
                  <source src={selectedFileURL} type={selectedFile.type} />
                </video>
              ) : (
                isImage && (
            ...
            <a onClick={handleSelectFile} href="" className="ls-link-secondary">
              Choose New File
            </a>
          </>
        ) : (
          <>
            ...
            <div>
              <button onClick={handleSelectFile} className="ls-button-light">
                Choose File
              </button>
              <p>Or Drag & Drop</p>
            </div>
